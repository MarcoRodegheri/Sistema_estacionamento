...
public class App {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            tentaExecutar(() -> ger.registrarSaida(placaTecno2, agora.plusMinutes(10)), "Carro 2 Sai (10min -> Grátis)");
            ...
            if (Math.abs(receitaReal - receitaEsperada) < 0.1) {
                ...
                System.out.println("Diferença na receita. Verifique se a dívida do estudante entra no relatório antes de ser paga.");
                
                System.out.println("   (Nota: Se a diferença for R$ 30,00, é porque o sistema só conta 'Pagos' e o Lucas está devendo.");
            }
